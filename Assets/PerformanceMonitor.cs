...
public class PerformanceMonitor : MonoBehaviour
{
    ...
    private AllCardPresenter cardPresenter;
    ...
    private bool showDetailedMemory = false;
    ...
    {
        var cardBoot = FindObjectOfType<CardUIBoot>();
        if (cardBoot != null)
        {
            // リフレクションを使ってpresenterフィールドにアクセス
            System.Reflection.FieldInfo fieldInfo = 
                typeof(CardUIBoot).GetField("presenter", 
    ...
    private void UpdateCardStats()
    {
        ...
        if (cardPresenter != null)
        {
            ...
            if (cardBoot != null)
            {
                ...
                System.Reflection.FieldInfo fieldInfo = 
                    typeof(CardUIBoot).GetField("remainingCards", 
                    System.Reflection.BindingFlags.NonPublic | 
                    System.Reflection.BindingFlags.Instance);
                ...
                fieldInfo = typeof(CardUIBoot).GetField("isLoadingBatch", 
                    System.Reflection.BindingFlags.NonPublic | 
                    System.Reflection.BindingFlags.Instance);
