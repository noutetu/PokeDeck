...
namespace Enum
{
    public static class EnumConverter
    {
        ...
        // 他の変換メソッドはコメントアウト - カードタイプと進化段階のみに集中するため
        /*
        // ----------------------------------------------------------------------
        // 文字列をWeaknessTypeに変換
        // ----------------------------------------------------------------------
        public static WeaknessType ToWeaknessType(string weaknessString)
        {
            if (string.IsNullOrEmpty(weaknessString))
                return WeaknessType.なし;
                
            switch (weaknessString)
            {
                case "草": return WeaknessType.草;
                case "炎": return WeaknessType.炎;
                case "水": return WeaknessType.水;
                case "雷": return WeaknessType.雷;
                case "闘": return WeaknessType.闘;
                case "超": return WeaknessType.超;
                case "悪": return WeaknessType.悪;
                case "鋼": return WeaknessType.鋼;
                case "ドラゴン": return WeaknessType.ドラゴン;
                case "無色": return WeaknessType.無色;
                case "なし": return WeaknessType.なし;
                default:
                    Debug.LogError($"❌ 未知の弱点タイプ: {weaknessString}");
                    return default;
            }
        }
