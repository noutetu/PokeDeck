...
public class SetMaxDamageArea : MonoBehaviour, IFilterArea
{
    ...
    private void OnDropdownValueChanged(int index)
    {
        ...
        {
            bool valueChanged = selectedDamage != damage;
            ...
            if (valueChanged || selectedComparisonType != DamageComparisonType.None)
            {
                OnFilterChanged?.Invoke();
            }
        }
    ...
    // ----------------------------------------------------------------------
    private void UpdateToggleVisualState(DamageComparisonType comparisonType, bool isOn)
    {
        ...
        {
            case DamageComparisonType.LessOrEqual:
                targetToggle = lessOrEqualToggle;
                break;
            case DamageComparisonType.Equal:
                targetToggle = equalToggle;
                break;
            case DamageComparisonType.GreaterOrEqual:
