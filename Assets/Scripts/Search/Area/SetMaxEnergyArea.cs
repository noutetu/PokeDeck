...
public class SetMaxEnergyArea : MonoBehaviour, IFilterArea
{
    ...
    private void OnDropdownValueChanged(int index)
    {
        ...
        {
            bool valueChanged = selectedEnergyCost != cost;
            ...
            if (valueChanged || selectedComparisonType != EnergyComparisonType.None)
            {
                OnFilterChanged?.Invoke();
            }
        }
    ...
    // ----------------------------------------------------------------------
    private void UpdateToggleVisualState(EnergyComparisonType comparisonType, bool isOn)
    {
        ...
        {
            case EnergyComparisonType.LessOrEqual:
                targetToggle = lessOrEqualToggle;
                break;
            case EnergyComparisonType.Equal:
                targetToggle = equalToggle;
                break;
            case EnergyComparisonType.GreaterOrEqual:
